#!/bin/sh
  ...
  # 
  # Package management
  # Perl uses cpan utility for module management. However we recommend to install cpanminus for installing modules easier:
  # 
  # cpan App::cpanminus
  # Now you can install Perl modules using
  # 
  # cpanm Module::Name
  # It is highly recommended to have build-essential Termux package to be installed, so Perl will be able to build native extensions.